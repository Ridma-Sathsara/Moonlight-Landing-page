...
>
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="flex items-center justify-between h-16">
      ...
      <div className="flex items-center space-x-4">
        ...
        <span className="text-xl font-bold font-major-mono transition-all duration-300 ease-in-out text-black">
      ...
      <div className="flex items-center space-x-5">
        ...
        <div className="relative">
          ...
          <button className="text-lg transition-all duration-300 ease-in-out text-black" onClick={handleSearchClick}>
            <FaSearch />
          </button>
        </div>
        ...
        <div className="hidden sm:flex items-center space-x-3">
          <button className="text-lg transition-all duration-300 ease-in-out text-black">
            <FaUserAlt />
          </button>
          <button className="text-lg transition-all duration-300 ease-in-out text-black">
            <FaShoppingCart />
  ...
  {isMobileMenuOpen && (
    <div className="sm:hidden flex flex-col items-center space-y-4 bg-white py-4 z-50 fixed top-16 left-0 right-0">
      {menuItems.map((item) => (
        <button
          key={item.path}
          onClick={() => handleNavigate(item.path)}
